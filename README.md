...
Repository: **https://github.com/OzDomer/jb-45800-5-project-3**
...
2. **The cost is identical.** The model runs the same number of turns and consumes the same tokens either way — the local loop only splits them into separate API requests that we control.
